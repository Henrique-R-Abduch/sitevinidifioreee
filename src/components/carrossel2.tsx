    ...
    <div className="h-1 w-20 bg-vf-orange mx-auto mb-6"></div>
        ...
        >
          <div
            ...
            className={`flex ${isMobile ? 'gap-0 px-0' : 'gap-4 px-2'} overflow-x-scroll scroll-smooth no-scrollbar scrollbar-none whitespace-nowrap`}
...
const transformations = [
  { id: 1, image: "/lovable-uploads/9.png" },
  { id: 2, image: "/lovable-uploads/10.png" },
  { id: 3, image: "/lovable-uploads/11.png" },
  { id: 4, image: "/lovable-uploads/12.png" },
];
